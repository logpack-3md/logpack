...
const Blog = () => {
  return (
    <div
      className="max-w-(--breakpoint-xl) mx-auto py-10 lg:py-16 px-6 xl:px-0 flex flex-col lg:flex-row items-start gap-12">
      <div>
        <div className="space-y-12">
          {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => (
            <Card
              ...
              <div
                className="shrink-0 aspect-video grow sm:w-56 sm:aspect-square bg-muted rounded-lg" />
              <CardContent className="px-0 sm:px-6 py-0 flex flex-col">
                ...
                <div
                  className="mt-4 flex items-center gap-6 text-muted-foreground text-sm font-medium">
