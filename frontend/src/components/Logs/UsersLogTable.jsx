    ...
    return (
        <div className="flex flex-1 flex-col bg-card rounded-xl border border-border shadow-sm overflow-hidden h-full">
            ...
            <div className="flex-1 w-full overflow-auto"> 
                {/* min-w-[1000px] Força a tabela a ser larga, gerando scroll horizontal no mobile */}
                <Table className="w-full min-w-[1000px]">
                    <TableHeader className="bg-muted/40 sticky top-0 z-10 backdrop-blur-sm">
                        <TableRow className="border-b border-border/60 hover:bg-transparent">
                            ...
                            <TableHead className="w-[120px] text-center h-11 text-xs uppercase font-bold text-muted-foreground whitespace-nowrap">Tipo Ação</TableHead>
                            <TableHead className="h-11 text-xs uppercase font-bold text-muted-foreground min-w-[300px]">Detalhes da Atividade</TableHead>
                            <TableHead className="w-[160px] text-right pr-6 h-11 text-xs uppercase font-bold text-muted-foreground whitespace-nowrap">Responsável</TableHead>
                        </TableRow>
                    </TableHeader>
            ...
            <div className="border-t border-border bg-background p-3 shrink-0 z-20">
                <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-4 w-full">
                    ...
                    <div className="flex items-center gap-4 text-xs text-muted-foreground w-full sm:w-auto justify-center sm:justify-start">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Select 
                                ...
                                disabled={loading}
                            >
                                <SelectTrigger className="h-7 w-[60px] bg-background border-border text-xs shadow-sm">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                    ...
                    <Pagination className="w-full sm:w-auto mx-0">
                        <PaginationContent className="gap-1 w-full justify-center sm:justify-end">
                            <PaginationItem>
                                <Button 
                                    variant="outline" 
                                    size="sm" 
                                    ...
                                    className="gap-1 h-8 px-3 text-xs shadow-sm w-24 sm:w-auto"
                                >
                                    <ChevronLeft className="h-3 w-3" /> Anterior
                                </Button>
                            </PaginationItem>
                            
                            <PaginationItem className="hidden sm:flex items-center justify-center min-w-[2rem] text-xs font-medium text-muted-foreground">
