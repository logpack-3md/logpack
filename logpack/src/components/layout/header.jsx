...
//       </Avatar>
//       <h2
//         className="font-bold text-xl px-2 bg-gradient-to-r from-[#68482f] to-[#cf966a] bg-clip-text text-transparent
//                   hover:from-[#8f5f3b] hover:to-[#e0a273]"
//       >
//         LogPack
//       </h2>
...
//           <NavigationMenuLink
//             href="/"
//             className="px-4 py-2 block text-lg font-bold rounded-md"
//           >
//             Home
//           </NavigationMenuLink>
//         </NavigationMenuItem>
...
//             <NavigationMenuLink
//               href="/sobre"
//               className="px-2 py-2 block w-27"
//             >
//               Nossa História
//             </NavigationMenuLink>
//             <NavigationMenuLink
...
//             <NavigationMenuLink
//               href="/contato"
//               className="px-4 py-2 block w-28"
//             >
//               Contate-nos
//             </NavigationMenuLink>
//           </NavigationMenuContent>
...
//   {/* Avatar do usuário e Botão de Tema (Desktop) */}
...
//                 <a
//                   href="/"
//                   className="py-2 block text-sm hover:bg-accent hover:text-accent-foreground rounded-sm"
//                 >
//                   Home
//                 </a>
//               </AccordionContent>
...
//                 <a
//                   href="/servicos"
//                   className="px-4 py-2 block text-sm hover:bg-accent hover:text-accent-foreground rounded-sm"
//                 >
//                   Assistência
//                 </a>
//               </AccordionContent>
...
//           {/* SwitchTheme e Avatar dentro da Sidebar (Mobile) */}
//           <div className="flex items-center justify-end gap-4 mt-4 p-2 border-t">
//             <SwitchTheme />
